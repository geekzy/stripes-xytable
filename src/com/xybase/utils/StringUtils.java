 /* File: com.miistwo.pa.action.EnquiryActionBean.java
 *
 * XYCommon - Utility
 ...
 */
 ...
 public class StringUtils {
     ...
     static boolean requiresEscape(char aChar) {
         return (int) aChar < HTML_ENTITIES.length - 1 && HTML_ENTITIES[((int) aChar)] != null;
     }
     ...
     static String escapeChar(char aChar) {
         return (int) aChar < HTML_ENTITIES.length - 1 && HTML_ENTITIES[((int) aChar)] != null
                 ? HTML_ENTITIES[((int) aChar)] : String.valueOf(aChar);
     }
      ...
      * @return camel case of the input
      */
     ...
     /**
      * Join contents of a collection with a delimiter returning a joined string.
      *
      * @param s Collection to join
      * @param delimiter delimiter to seperate each item in collection
