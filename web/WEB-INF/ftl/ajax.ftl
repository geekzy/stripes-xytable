...
<div class="box" id="gridOneBox">
    ...
    <!-- Grid 1 -->
    <table id="userGrid" class="grid" cellpadding="0" cellspacing="0"></table>
    <!-- Pagging -->
...
<div class="box" id="gridTwoBox">
    ...
    <!-- Grid 2 -->
    <table id="userGridTwo" class="grid" cellpadding="0" cellspacing="0"></table>
    <!-- End Grid 2 -->
...
$(function() {
    var userGrid = $('#userGrid').xytable({
        ...
        pager: {
            ajax:true,
            id:'pager-one',
            base:'${contextPath}/action/user?json=',
        ...
        sorter: {
            remote: {
                href:'${contextPath}/action/user?json='[#if actionBean.userGrid.sortx??],
                sortx:'${actionBean.userGrid.sortx}', sortd: ${actionBean.userGrid.sortd}[/#if]
            }
        },
        remote: {
            url:'${contextPath}/action/user?json=', type:'json', key:'rows'
        },
        callback: {
